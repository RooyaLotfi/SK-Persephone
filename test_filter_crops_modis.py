...
def main():
    ...
    SMAP_path = os.path.join("data", "Modis_tif", "6_cropped_RM")
    PATH = SMAP_path
    ...
    for rm_id in RM_ID:
        for year in YEAR:
            ...
            # TODO: Fix this it goes through all the subdirectories too. make it to just find images in one level
